...
import { FaTachometerAlt, FaCalendar, FaUsers, FaFileAlt, FaClipboard, FaSignOutAlt } from 'react-icons/fa';
  ...
  return (
    <div style={{ backgroundColor: 'white', minHeight: '100vh' }}>
      ...
      >
        ...
        <div style={{ fontSize: '1.2rem', fontFamily: 'Poppins, sans-serif', fontWeight: 'bold', textAlign: 'left' }}>
      ...
      {/* Main Content */}
            ...
            {/* Profile Section */}
      <div style={{ backgroundColor: '#0D1A2A', padding: '50px', margin: '50px 250px', borderRadius: '20px', boxShadow: '0 10px 20px rgba(0, 0, 0, 0.1)' }}>
        <div style={{ display: 'flex', alignItems: 'center', position: 'relative' }}>
          <div style={{ position: 'absolute', top: '0px', left: '60px', width: '300px', height: '300px', overflow: 'hidden', borderRadius: '20px' }}>
            <img src={profileImage || defaultProfileImage} alt="Profile" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>

          <div style={{ marginLeft: '400px' }}>
            <h2 style={{ fontSize: '60px', fontFamily: 'Poppins, sans-serif', fontWeight: 700, letterSpacing: '1px', color: '#FFFFFF' }}>
              {user.full_name || 'Loading name...'}
            </h2>
            <div style={{ fontSize: '18px', fontFamily: 'Poppins, sans-serif', fontWeight: 500, color: '#FFFFFF' }}>
              ID {user.id ? `${user.id} • @${user.username}` : 'Loading user info...'}
            </div>
